...
const MyPage = ({history}) => {
  ...
  useEffect(() =>{
    const url = "http://15.165.18.192:8080/api/selMem";
    const userdata = {
    ...
    axios
      ...
      .then(res=> {
        ...
        setValues({
          ...
          // password: res.data.resdata.upw,
          // confirm: res.data.resdata.upw,
          name: res.data.resdata.uname,
          nickname: res.data.resdata.unickname,
          phonenumber: res.data.resdata.uphonenum,
          email: res.data.resdata.uemail,
          address: res.data.resdata.uaddress,
          favor_ctg: res.data.resdata.ufavorList,
          photo: res.data.resdata.uprofilephoto,
          birth_date: res.data.resdata.ubirth_date,
        });
        console.log(values,"가치  ");
      })
  }, [])
  ...
  const save = e => {
    ...
    e.preventDefault();
    const URL = "http://15.165.18.192:8080/api/updateMem";
    const data = {
      uid: values.id,
      // upw: values.password,
      uname: values.name,
